...
In order to give your keybinds actual functionality, you should look at client-side events such as the `onTick` method in the [Instance](/client-events/instance) event.
