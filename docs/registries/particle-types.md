...
Note that in order for the particles to appear on the client, you'll still need to provide a sprite sheet using the client-side [Particle Providers](/client-helpers/particle-providers) Helper.
